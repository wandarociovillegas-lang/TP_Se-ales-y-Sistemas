...
plt.ylabel("Amplitud")
plt.subplot(2,1 ,2)
plt.plot(t_signal_y[secuencia_A1[1]:secuencia_A1[5]],signal_x[secuencia_A1[1]:secuencia_A1[5]])
...
sf.write("nuevo_audio2.wav", signal_y, fs)
